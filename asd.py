...
class ASD:
    ...
    def run(self, audio_data_dict: Dict, use_saved_chunks=False, chunk_dir='./chunks', speaker_name='name'):
        if use_saved_chunks:
    ...
    def produce_evaluation(self, data_dict: Dict, speaker_name='name') -> pd.DataFrame:
        model = self.model
        model.eval()
